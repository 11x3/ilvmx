defmodule ILM.Signal.Server do
  use GenServer
  ...
  @doc """
  Collect all registered `Signal`s.
  """
  def collect!(signal) do
    # defmodule Signal do
    #   defstruct     path: nil,
    #              content: nil,
    #               source: nil,
    ...
    #todo: map items/programs from signal.path
    #todo: map path segments "/fix/macpro" to items
    
    # items   = Item.list(signal.nubspace)
  ...
  # """
  # def capture!(signal_path, item) do
  #   #Map.add(@programs, signal, item)
  # end
  #
  #
  # ## Nubspace
