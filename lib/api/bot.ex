defmodule Bot do
  ...
  #   ILM.Castle.Tower.Server.signal!(Signal.w nubspace, item)
  # end
  #
  # @doc """
  ...
  #   unless Wizard.valid_path?(item_path) and File.exists?(item_path) do
  #     nil
  #   else
  #     File.read! item_path
  #   end
  ...
  # """
  # def drop(item) do
  #   obj_relative_path = "#{ ILM.Castle.uuid }"
  #
  #   item_path = Path.join("priv/static/obj", obj_relative_path)
  #   unless Wizard.valid_path?(item_path) do
  #     nil
  #   else
